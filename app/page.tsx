          ...
          <div className="space-y-5">
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                {!rf ? (
                  <div className="relative border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all hover:border-indigo-400/50 hover:bg-indigo-50/30 group"
                    onClick={() => ri.current?.click()} onDrop={(e) => hd(e, "r")} onDragOver={(e) => e.preventDefault()}>
                    ...
                    <div className="flex flex-col items-center gap-2 py-3">
                      ...
                      <p className="text-sm font-medium text-slate-600">拖拽或<span className="text-indigo-600">点击上传</span></p>
                      <p className="text-xs text-slate-400">.txt .docx</p>
                    </div>
                  </div>
                ) : (
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                {!jf ? (
                  <div className="relative border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-all hover:border-amber-400/50 hover:bg-amber-50/30 group"
                    onClick={() => ji.current?.click()} onDrop={(e) => hd(e, "j")} onDragOver={(e) => e.preventDefault()}>
                    ...
                    <div className="flex flex-col items-center gap-2 py-3">
                      ...
                      <p className="text-sm font-medium text-slate-600">拖拽或<span className="text-amber-600">点击上传</span></p>
                      <p className="text-xs text-slate-400">.txt .docx</p>
                    </div>
                  </div>
                ) : (
